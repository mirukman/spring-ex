        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form id="openForm" action="/board/modify" method="get">
                    ...
                    <input type="hidden" id="page" name="page" value='<c:out value="${criteria.page}" />'>
                    <input type="hidden" id="page" name="type" value='<c:out value="${criteria.type}" />'>
                    <input type="hidden" id="page" name="keyword" value='<c:out value="${criteria.keyword}" />'>
                </form>
...
<script type="text/javascript">
    $(document).ready(function () {
        const bnoValue = '<c:out value="${boardVo.bno}" />';
        const replyUl = $(".chat");
            ...
            replyService.getList({
                ...
                function (replyCount, list) {
                    ...
                    for (let i = 0, len = list.length || 0; i < len; i++) {
                        ...
                        str += "<div><div class='header'><string class='primary-font'>" + list[i].replyer +
                            "</strong>";
            ...
            $.getJSON("/board/getAttachList", {bno: bno}, function(arr) {
                ...
                $(".uploadResult").on("click", "li", function(e) {
                    ...
                    if(li.data("type")) {
                        ...
                        self.location = "/upload/download?fileName=" + Wpath;
                    }
                });
            });
        })();
